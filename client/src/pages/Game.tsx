      ...
      <div className="fixed inset-0 bg-black flex flex-col items-center justify-center p-4 sm:p-8 scanlines z-50 overflow-y-auto">
        ...
        >
          ...
          <div className="pt-4 sm:pt-6 space-y-3 sm:space-y-4">
            ...
            <p className="text-white" style={{ fontFamily: 'var(--font-pixel)', fontSize: 'clamp(12px, 3.5vw, 18px)', textShadow: '0 0 10px rgba(255,255,255,0.2)' }}>Jeremiah Christopher Feliciano</p>
          </div>
